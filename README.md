...
pixi add spyder-kernels
# for installing globally
pixi global install spyder-kernels
```
...
It is possible to list all of the versions of `spyder-kernels` available on your platform:
...
```
pixi search spyder-kernels --channel conda-forge
```
